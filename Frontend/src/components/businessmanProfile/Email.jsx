...
const ContactEditPage = ({ type = "email" }) => {
  ...
  const handleContactSubmit = () => {
    ...
    if (newContact === currentContact) {
      newErrors.newContact = `New ${
        isEmail ? "email" : "phone number"
      } must be different from current ${isEmail ? "email" : "phone number"}`;
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      <div className="max-w-md sm:max-w-lg md:max-w-2xl mx-auto px-4 py-4 sm:py-6 lg:py-8">
        {/* Header */}
        <div
          className={`bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-xl border border-gray-200 overflow-hidden mb-4 sm:mb-6 lg:mb-8 transition-all duration-700 ${
        ...
        >
          ...
          <div className="bg-gray-50 border-t border-gray-200 p-3 sm:p-4">
            <div className="flex items-center justify-center space-x-2 sm:space-x-4 lg:space-x-8">
              <div className="flex items-center space-x-1 sm:space-x-2">
                ...
                <span
                  className={`text-xs sm:text-sm font-medium ${
                    step === "edit" ? "text-gray-600" : "text-green-600"
                  } hidden sm:inline`}
                >
                  Edit
                </span>
              ...
              <div
                className={`w-4 sm:w-8 lg:w-16 h-1 rounded-full transition-all duration-500 ${
        ...
        {/* Content */}
        <div
          className={`bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-4 sm:p-6 transition-all duration-500 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      isEmail
                        ? setConfirmContact(e.target.value)
                        : handlePhoneConfirmInput(e.target.value)
                    }
                    className={`w-full px-3 py-3 sm:px-4 border-2 rounded-lg sm:rounded-xl focus:ring-4 focus:ring-gray-100 focus:border-gray-500 transition-all duration-300 text-sm sm:text-base ${
          ...
          {step === "verify" && (
            <div className="space-y-4 sm:space-y-6">
              <div className="text-center">
                ...
                <p className="font-semibold text-gray-600 text-sm sm:text-base break-all px-4">
                  {newContact}
                </p>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg sm:rounded-xl p-3 sm:p-4">
                <div className="flex items-center justify-between">
                  <div className="text-left">
                    ...
                    <p className="text-green-700 font-semibold text-sm sm:text-base break-all">
                      {newContact}
                    </p>
                  </div>
        ...
        {step !== "success" && (
          <div
            className={`mt-4 sm:mt-6 bg-gray-50 border border-gray-200 rounded-xl sm:rounded-2xl p-3 sm:p-4 transition-all duration-500 ${
              isVisible
            ...
            <div className="flex items-start space-x-2 sm:space-x-3">
              ...
              <div>
                ...
                <ul className="text-xs sm:text-sm text-gray-700 space-y-1">
                  ...
                  <li>
                    • We'll never share your {contactType} with third parties
                  </li>
