...
const Button = ({ children, onClick, loading, variant = 'primary', icon, className = '', disabled, ...props }) => {
...
const DatePicker = ({ value, onChange, disabled }) => {
  ...
  const renderCalendar = () => {
    ...
    for (let i = 0; i < firstDay; i++) {
      days.push(<div key={`empty-${i}`} className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10"></div>);
    }
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      const isToday = today.toDateString() === new Date(currentMonth.getFullYear(), currentMonth.getMonth(), day).toDateString();
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <ChevronDown className={`w-4 h-4 md:w-5 md:h-5 text-[#6b7280] transition-transform duration-300 ${isOpen ? 'rotate-180' : ''} group-hover:text-[#1f2937]`} />
      </button>
                ...
                <div className="flex items-center space-x-1 sm:space-x-2">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <ChevronDown className={`w-2.5 h-2.5 sm:w-3 sm:h-3 md:w-4 md:h-4 transition-transform ${monthDropdownOpen ? 'rotate-180' : ''}`} />
                    </button>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <ChevronDown className={`w-2.5 h-2.5 sm:w-3 sm:h-3 md:w-4 md:h-4 transition-transform ${yearDropdownOpen ? 'rotate-180' : ''}`} />
                    </button>
            ...
            <div className="relative flex flex-col items-center space-y-4 sm:space-y-6 md:flex-row md:space-y-0 md:space-x-6 lg:space-x-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex items-center justify-center md:justify-start space-x-2 mb-2 sm:mb-4">
                  ...
                  <span className="text-white/80 font-medium text-sm sm:text-base">Active now</span>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
              ...
              <div className="space-y-3 sm:space-y-4 group">
                <div className="flex items-center space-x-2 sm:space-x-3">
                  ...
                  <h3 className="font-bold text-xs sm:text-sm uppercase tracking-wider text-[#6b7280]">Username</h3>
                </div>
              ...
              <div className="space-y-3 sm:space-y-4 group">
                <div className="flex items-center space-x-2 sm:space-x-3">
                  ...
                  <h3 className="font-bold text-xs sm:text-sm uppercase tracking-wider text-[#6b7280]">Email Address</h3>
              ...
              <div className="space-y-3 sm:space-y-4 group">
                <div className="flex items-center space-x-2 sm:space-x-3">
                  ...
                  <h3 className="font-bold text-xs sm:text-sm uppercase tracking-wider text-[#6b7280]">Phone Number</h3>
                  <div className="flex items-center space-x-1 px-2 sm:px-3 py-0.5 sm:py-1 bg-[#fef3c7] rounded-md sm:rounded-lg">
                    <Shield className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-[#d97706]" />
                    <span className="text-xs font-bold text-[#d97706] uppercase">Protected</span>
                  </div>
              ...
              <div className="space-y-3 sm:space-y-4 group">
                <div className="flex items-center space-x-2 sm:space-x-3">
                  ...
                  <h3 className="font-bold text-xs sm:text-sm uppercase tracking-wider text-[#6b7280]">Date of Birth</h3>
                </div>
