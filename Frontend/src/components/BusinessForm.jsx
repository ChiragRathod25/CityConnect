...
const ModernSellerForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    businessType: "",
    businessCategory: "",
    businessDescription: "this is the business description which is required to register your business",
    yearsInBusiness: "",
    ...
    switch (step) {
      ...
      case 4:
        if (!formData.govtIdProof) {
          newErrors.govtIdProof = "Government ID proof is required for verification";
        }

        if (!formData.selfieWithId) {
          newErrors.selfieWithId = "Selfie with ID is required for face verification";
        }
        ...
        if (!formData.professionalPhoto) {
          newErrors.professionalPhoto = "Professional profile photo is required";
        }
        break;
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      alert("Registration successful! Welcome to CityConnect.");
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <ToggleSwitch
                ...
                description="I can provide services at customer location"
                checked={formData.homeServiceAvailable}
                onChange={(value) => handleInputChange("homeServiceAvailable", value)}
              />
            </div>
          </motion.div>
        );
        ...
        return (
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 mt-2">Complete KYC verification to ensure platform security</p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="text-lg font-semibold text-blue-800">KYC Verification (Required)</h4>
              </div>
              ...
              <div className="mt-4 p-4 bg-blue-100 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-blue-700">
                    <p className="font-medium mb-1">Identity Verification Process:</p>
                    <ul className="space-y-1 text-blue-600">
                      <li>• Your ID will be verified using OCR technology</li>
                      <li>• Facial recognition will match your selfie with ID photo</li>
                      <li>• This helps prevent fake accounts and ensures platform security</li>
              ...
              <div className="mt-4 p-4 bg-yellow-100 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-yellow-700">
                    ...
                    <p>
                      While business license is optional, providing it helps build trust with customers
                      and may unlock additional features.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="text-lg font-semibold text-green-800">Professional Profile</h4>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-green-700">
                    ...
                    <ul className="space-y-1 text-green-600">
                      ...
                      <li>• This photo will be displayed on your seller profile</li>
                    </ul>
                  </div>
                </div>
              </div>
                  ...
                  {formData.location && (
                    <div className="md:col-span-2">
                      ...
                      {formData.location.lat !== 0 && formData.location.lng !== 0 && (
                        <p className="ml-2 text-gray-400 text-xs mt-1 font-mono">
              ...
              <GlassCard className="p-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      { key: "govtIdProof", label: "Government ID Proof", required: true },
                ...
                <div className="mb-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      ...
                      { key: "businessPhoto", label: "Business/Workspace Photo", required: true },
                    ].map(({ key, label, required }) => (
                      <div
                        key={key}
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            {required ? (
                              ...
                              <span className="text-green-600 text-xs">(Optional)</span>
                            )}
                          </div>
                          <p className="text-xs text-gray-600">
                            {formData[key] ? "Uploaded ✓" : "Not uploaded"}
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-1 gap-4">
                    {[
                      { key: "professionalPhoto", label: "Professional Profile Photo", required: true },
                    ].map(({ key, label, required }) => (
                      <div
                        key={key}
                      ...
                      >
                        ...
                        >
                          {formData[key] ? <CheckCircle size={16} /> : <Camera size={16} />}
                        </div>
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            <p className="font-medium text-sm">{label}</p>
                ...
                <div className="mt-6 pt-4 border-t border-gray-200">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                    <div
                      ...
                      style={{ width: `${getDocumentUploadProgress().percentage}%` }}
                    ></div>
                  </div>
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-4 text-xs">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-600">
                        Required: {getDocumentUploadProgress().required.completed}/
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-600">
                        Optional: {getDocumentUploadProgress().optional.completed}/
...
const MapComponent = ({ onLocationSelect, selectedLocation, error }) => {
  ...
  const handleManualLocationSubmit = () => {
    const { address, city, state, pincode, lat, lng } = manualLocation;
