...
//   const business = await databaseService.getBusiness(businessId);
//   const contact = await databaseService.getBusinessContact(businessId);
...
const mockBusinessData = {
  business: {
    ...
    type: "both",
    category: "services",
    description: "We provide top-notch business solutions including consulting, development, and support services. Our team of experts ensures quality delivery for all your business needs.",
  ...
  products: Array.from({ length: 15 }, (_, i) => ({
    _id: `prod-${i + 1}`,
    name: `Product ${i + 1}`,
    description: "High-quality product with excellent features and durability. Perfect for your business needs.",
    price: 99.99 + i * 10,
    stock: 50 + i * 5,
    category: "Electronics",
    brand: "Premium Brand",
    images: [`https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&h=400&fit=crop&sig=${i}`],
    tags: ["popular", "new"],
    warranty: "1 year",
    deliveryCharge: 5.99,
    returnPolicyDays: 30,
  ...
  services: Array.from({ length: 12 }, (_, i) => ({
    _id: `serv-${i + 1}`,
    name: `Service ${i + 1}`,
    description: "Professional service delivered by experienced experts with guaranteed satisfaction and quality results.",
    price: 199.99 + i * 20,
    duration: "2 hours",
    serviceType: i % 3 === 0 ? "onsite" : i % 3 === 1 ? "offsite" : "remote",
    availability: "Mon-Fri 9AM-6PM",
    category: "Professional Services",
    images: [`https://images.unsplash.com/photo-1556761175-b413da4baf72?w=400&h=400&fit=crop&sig=${i}`],
  ...
  reviews: [
    { rating: 5, comment: "Excellent service!", user: "John Doe", createdAt: "2024-10-15" },
    { rating: 4, comment: "Very professional team", user: "Jane Smith", createdAt: "2024-10-20" },
    { rating: 5, comment: "Highly recommended!", user: "Mike Johnson", createdAt: "2024-10-25" },
  ],
};
...
const BusinessProfilePage = () => {
  ...
  const { business, contact, location, hours, products, services, reviews } = businessData;
                  ...
                  {business.images.map((_, index) => (
                    <button
                      ...
                      className={`w-3 h-3 rounded-full transition-all duration-200 ${
                        index === selectedImage ? "bg-white scale-125" : "bg-white/50 hover:bg-white/80"
                      }`}
                    />
                  ))}
                </div>
                ...
                <div className="flex-1 lg:pr-8">
                  ...
                  >
                    <div className="flex items-center space-x-4 mb-3">
                      <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold" style={{ color: "#1f2937" }}>
                        {business.name}
                      </h1>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-4 mb-4">
                      ...
                      <span
                        className="px-4 py-2 rounded-xl text-lg font-semibold capitalize"
                        style={{ backgroundColor: "#f8fafc", color: "#6b7280", border: "2px solid #e2e8f0" }}
                      >
                        {business.type}
                      </span>
                      {reviews.length > 0 && (
                        <div className="flex items-center space-x-2">
                          ...
                          <span style={{ color: "#6b7280" }}>({reviews.length} reviews)</span>
                        </div>
                      )}
                    </div>
                ...
                >
                  <div className="space-y-3">
                    <div className="flex items-center space-x-2 lg:justify-end">
                      ...
                      <span style={{ color: "#6b7280" }}>Est. {business.establishedYear}</span>
                    </div>
                    <div className="flex items-center space-x-2 lg:justify-end">
                      <Users className="w-5 h-5" style={{ color: "#6b7280" }} />
                      <span style={{ color: "#6b7280" }}>{business.numberOfEmployees} Employees</span>
                    </div>
                  </div>
                </motion.div>
              </div>
                  ...
                  <div className="space-y-4">
                    {contact.phone && (
                      ...
                      >
                        ...
                        <span className="font-medium" style={{ color: "#1f2937" }}>{contact.phone}</span>
                      </div>
                    )}
                    ...
                    {contact.email && (
                      ...
                      >
                        ...
                        <span className="font-medium" style={{ color: "#1f2937" }}>{contact.email}</span>
                      </div>
                    )}
                ...
                >
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <div className="font-bold text-sm mb-1" style={{ color: "#1f2937" }}>
                          Address
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {contact.socialMedia.facebook && (
                        ...
                        >
                          ...
                          <span className="font-medium text-sm ml-2">Facebook</span>
                        </a>
                      )}
                      {contact.socialMedia.instagram && (
                        ...
                        >
                          ...
                          <span className="font-medium text-sm ml-2">Instagram</span>
                        </a>
                      )}
                      {contact.socialMedia.twitter && (
                        ...
                        >
                          ...
                          <span className="font-medium text-sm ml-2">Twitter</span>
                        </a>
                      )}
                      {contact.socialMedia.youtube && (
                        ...
                        >
                          ...
                          <span className="font-medium text-sm ml-2">YouTube</span>
                        </a>
                      )}
                      {contact.socialMedia.linkedin && (
                        ...
                        >
                          ...
                          <span className="font-medium text-sm ml-2">LinkedIn</span>
                        </a>
                      )}
                    </div>
                  </motion.div>
              ...
              >
                <div className="flex items-center space-x-4 mb-8 overflow-x-auto">
                  <button
                    ...
                    style={{
                      backgroundColor: activeTab === "products" ? "#1f2937" : "#e2e8f0",
                      color: activeTab === "products" ? "#ffffff" : "#1f2937",
                    }}
                  >
                    <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: activeTab === "services" ? "#1f2937" : "#e2e8f0",
                      color: activeTab === "services" ? "#ffffff" : "#1f2937",
                    }}
                  >
                    <div className="flex items-center space-x-2">
                        ...
                        >
                          ...
                          <div className="p-5">
                            <div className="flex items-start justify-between mb-3">
                              <h5 className="text-xl font-bold flex-1" style={{ color: "#1f2937" }}>
                                {product.name}
                              </h5>
                              <span className="text-xl font-bold ml-2" style={{ color: "#1f2937" }}>
                            ...
                            <div className="absolute top-3 right-3 flex flex-col space-y-2">
                              ...
                              <span
                                className={`px-3 py-1 rounded-lg text-xs font-semibold ${
                                  service.isActive ? "bg-green-500/90" : "bg-red-500/90"
                                } text-white`}
                              >
                            ...
                            <div className="space-y-2 mb-4">
                              ...
                              {service.serviceType && (
                                <div className="flex items-center justify-between text-sm">
                                  ...
                                  <span className="font-semibold capitalize" style={{ color: "#1f2937" }}>
                                    {service.serviceType}
                                  </span>
                                </div>
                              )}
              ...
              >
                <div className="p-8 rounded-2xl" style={{ backgroundColor: "#f8fafc" }}>
                  ...
                  <p className="text-lg mb-6" style={{ color: "#6b7280" }}>
                    Get in touch today to discuss your needs and discover how we can help your business grow.
                  </p>
