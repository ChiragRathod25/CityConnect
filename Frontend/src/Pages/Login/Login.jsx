...
// import { useState } from 'react';
// import { Eye, EyeOff, Mail, Phone, ArrowLeft, CheckCircle, Briefcase, User, Star } from 'lucide-react';
// import { GeometricShapes, MovingDots } from '../../components/CustomAnimation';
...
//       bgColor: "linear-gradient(135deg, #3b82f6, #1d4ed8)", // Blue gradient
//     },
//     {
//       id: "user",
//       title: "User",
...
//       bgColor: "linear-gradient(135deg, #10b981, #047857)", // Green gradient
//     },
//   ];
...
//             <p className="text-sm text-gray-600">
//               Don't have an account?{' '}
//               <NavLink to="/signup" className="text-gray-800 hover:text-gray-600 font-medium transition-colors">
//                 Sign up
//               </NavLink>
//             </p>
//           </div>
...
const LoginPage = () => {
  ...
  const phoneRegex = /^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[(]?[0-9]{1,4}[)]?[-\s\.]?[0-9]{1,4}[-\s\.]?[0-9]{1,9}$/;
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  ...
                  <span className="font-medium">
                    {forgotPasswordMethod === 'phone' ? formData.resetPhone : formData.resetEmail}
                  </span>
                </p>
              </div>
              {/* Verification Code Input */}
              ...
              <div onSubmit={handleForgotPassword}>
                {forgotPasswordMethod === 'email' ? (
                  ...
                  <div className="mb-6">
                    ...
                    />
                    {errors.resetPhone && (
                      <p className="text-xs text-red-500 mt-1">{errors.resetPhone}</p>
                    )}
                    <p className="text-xs text-gray-500 mt-2">
                      We'll send a verification code to your phone number
                    </p>
