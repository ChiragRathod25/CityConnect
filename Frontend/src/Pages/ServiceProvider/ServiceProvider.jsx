...
const ServiceProviderListing = () => {
  ...
  const serviceProviders = [
    {
      ...
      description:
        "Award-winning photography studio specializing in luxury weddings, corporate events, and artistic portraits. We blend creativity with technical excellence to deliver stunning visual stories that last a lifetime.",
      type: "Photography",
      category: [
        "Wedding Photography",
        "Corporate Events",
      ...
      reviews: [
        {
          ...
          rating: 5,
          description:
            "Absolutely phenomenal work! The team captured our wedding day with such artistry and professionalism. Every single photo tells a story, and the attention to detail is incredible. We couldn't be happier with the results!",
          images: [
          ...
          reviewer: {
            ...
            photo:
              "https://images.unsplash.com/photo-1494790108755-2616b612b672?w=60&h=60&fit=crop&crop=face",
          },
          date: "2024-01-15",
        },
        {
          ...
          rating: 5,
          description:
            "Outstanding corporate event photography. The team was discreet, professional, and captured all the key moments perfectly. The final gallery exceeded our expectations completely.",
          images: [],
          reviewer: {
            name: "Marcus Chen",
            photo:
        ...
        },
        {
          ...
          rating: 4,
          description:
            "Incredible portrait session! Very creative approach and made us feel comfortable throughout. The lighting and composition were masterful.",
          images: [
        ...
        },
        {
          ...
          rating: 5,
          description:
            "Elite Photography Studio transformed our product launch event into a visual masterpiece. Every shot was perfectly composed and edited to perfection.",
          images: [],
          reviewer: {
            name: "David Wilson",
            photo:
      ...
      reviews: [
        {
          ...
          rating: 4,
          description:
            "Quick and efficient service. Fixed our electrical issue promptly.",
          images: [],
          reviewer: {
            name: "John Smith",
            photo:
  ...
  const prevImage = () => {
    setSelectedImage(
      (prev) => (prev - 1 + provider.images.length) % provider.images.length
    );
  };
  ...
  const prevReview = () => {
    setCurrentReview(
      (prev) => (prev - 1 + provider.reviews.length) % provider.reviews.length
    );
  };
                          ...
                          <div className="flex-1">
                            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-3 sm:mb-4">
                              <div>
                                ...
                                >
                                  {
                                    provider.reviews[currentReview].reviewer
                                      .name
                                  }
                                </h5>
                                <div className="flex items-center space-x-2 sm:space-x-3">
                                  <div className="flex items-center space-x-1">
                                    {renderStars(
                                      provider.reviews[currentReview].rating
                                    )}
                                  </div>
                                  <span
                              ...
                              >
                                {new Date(
                                  provider.reviews[currentReview].date
                            ...
                            {provider.reviews[currentReview].images &&
                              provider.reviews[currentReview].images.length >
                                0 && (
                                <div className="flex space-x-2 sm:space-x-4 overflow-x-auto pb-2">
                                  {provider.reviews[currentReview].images.map(
                                    (image, index) => (
                                      <div
                                        key={index}
