...
const mockServices = [
  {
    ...
    description: "Professional haircut service with expert stylists. Includes consultation, precision cutting, and styling with premium products.",
    ...
    images: ["https://images.unsplash.com/photo-1562004760-aceed7bb0fe3?w=800&h=600&fit=crop"],
    warrantyDays: 7,
  ...
  },
  {
    ...
    description: "Relaxing full body massage therapy session with aromatherapy oils. Perfect for stress relief and muscle relaxation.",
  ...
  },
  {
    ...
    description: "Custom website development with modern technologies. Includes responsive design, SEO optimization, and content management system.",
  ...
  },
  {
    ...
    description: "One-on-one personal training with certified fitness trainer. Customized workout plan and nutrition guidance included.",
    category: "Fitness",
    price: 80,
    duration: "1 hour",
    serviceType: "onsite",
    ...
    images: ["https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800&h=600&fit=crop"],
    warrantyDays: 0,
    cancellationPolicy: "24hr",
    isActive: true,
  },
  {
    ...
    description: "Professional deep cleaning service for your home. Includes all rooms, kitchen, bathrooms, and common areas with eco-friendly products.",
  ...
  },
  {
    ...
    description: "Professional photography session for portraits, events, or products. Includes editing and high-resolution digital copies.",
  ...
  },
  {
    ...
    description: "Complete car detailing including exterior wash, interior cleaning, waxing, and polishing. Makes your car look brand new.",
    category: "Automotive",
    price: 200,
    duration: "4 hours",
    serviceType: "offsite",
    ...
    images: ["https://images.unsplash.com/photo-1607860108855-64acf2078ed9?w=800&h=600&fit=crop"],
    warrantyDays: 7,
    cancellationPolicy: "24hr",
    isActive: true,
  },
      ...
      <div className="container mx-auto px-4">
        ...
        {services.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 md:py-24">
            ...
            >
              <BriefcaseIcon className="w-16 h-16 md:w-20 md:h-20" style={{ color: "#6b7280" }} />
            </div>
          ...
          <>
            ...
            <div className="mb-6">
              ...
              >
                <BriefcaseIcon className="w-5 h-5" style={{ color: "#1f2937" }} />
                <span className="font-semibold" style={{ color: "#1f2937" }}>
                  Total Services: {services.length} | Showing {startIndex + 1}-{Math.min(endIndex, services.length)}
                </span>
              </div>
            </div>
                ...
                >
                  ...
                  <div className="relative h-48">
                    <div className="absolute inset-0 overflow-hidden rounded-t-2xl">
                      <img
                        src={service.images[0] || "https://via.placeholder.com/800x600?text=Service"}
                        alt={service.name}
                    ...
                    <div
                      ...
                      style={{ backgroundColor: "rgba(31, 41, 55, 0.9)", color: "#ffffff" }}
                    >
                    ...
                    <div className="space-y-2 mb-4">
                      <div className="flex items-center justify-between text-sm">
                        <div className="flex items-center space-x-2">
                          <ClockIcon className="w-4 h-4" style={{ color: "#6b7280" }} />
                      ...
                      {service.availability && (
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="font-semibold text-right" style={{ color: "#1f2937" }}>
                            {service.availability}
                          </span>
                        </div>
                      )}
                      ...
                      {service.warrantyDays > 0 && (
                        <div className="flex items-center justify-between text-sm">
                          <div className="flex items-center space-x-2">
                            <ShieldIcon className="w-4 h-4" style={{ color: "#6b7280" }} />
                      ...
                      <div className="flex items-center justify-between text-sm">
                        <div className="flex items-center space-x-2">
                          <XCircleIcon className="w-4 h-4" style={{ color: "#6b7280" }} />
                          <span style={{ color: "#6b7280" }}>Cancel Policy</span>
                        </div>
                        <span className="font-semibold text-right" style={{ color: "#1f2937" }}>
