...
const ContactMessagesAdmin = () => {
  ...
  const [allMessages] = useState([
    {
      ...
      message:
        "I'm interested in your services. Can you provide more details about your pricing plans?",
      status: "new",
    ...
    },
    {
      ...
      message:
        "We'd like to explore partnership opportunities with your organization.",
      status: "read",
    ...
    },
    {
      ...
      message:
        "I'm experiencing issues with the login functionality. Can someone help?",
      status: "replied",
    ...
    },
    {
      ...
      message:
        "Your website looks amazing! Just wanted to share some positive feedback.",
      status: "new",
    ...
    },
    {
      ...
      message:
        "Do you offer enterprise solutions? We have a team of 50+ people.",
      status: "archived",
    ...
    },
    {
      ...
      subject: "Bug Report",
      message:
        "Found a bug in the checkout process. It doesn't accept international cards.",
      status: "read",
  ...
  const filteredMessages =
    filter === "all"
      ? allMessages
      : allMessages.filter((msg) => msg.status === filter);
      ...
      >
        ...
        >
          <div className="flex justify-center mb-4">
            <div className="w-20 h-20 rounded-3xl bg-[#1f2937] flex items-center justify-center shadow-lg">
              <MessageSquare className="w-10 h-10 animate-pulse text-white" />
            </div>
          </div>
          <h1 className="text-4xl font-bold text-[#1f2937] mb-2">
            Contact Messages
          </h1>
          <p className="text-[#6b7280]">View and manage customer inquiries</p>
        </motion.div>
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full font-medium capitalize transition-all duration-300 ${
                filter === status
                  ...
                  : "bg-[#ffffff] text-[#6b7280] hover:bg-[#e2e8f0] hover:scale-105"
              }`}
            >
              {status} (
              {status === "all"
                ? allMessages.length
                : allMessages.filter((m) => m.status === status).length}
              )
            </button>
          ))}
        </motion.div>
          ...
          <AnimatePresence mode="popLayout">
            {currentMessages.map((message, index) => (
              <motion.div
                ...
                className="bg-[#ffffff] rounded-2xl p-6 shadow-md cursor-pointer border border-[#e5e7eb] hover:border-[#9ca3af] transition-all duration-300"
              >
        ...
        <AnimatePresence>
          {selectedMessage && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 bg-[#000000] bg-opacity-50 flex items-center justify-center p-4 z-50"
            ...
            >
              <motion.div
                ...
                className="bg-[#ffffff] rounded-3xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl"
              >
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[#1f2937] font-semibold mt-1">
                  ...
                  <div>
                    ...
                    <span
                      className={`inline-block px-4 py-2 rounded-full text-sm font-medium mt-1 ${getStatusColor(
                ...
                <div className="flex gap-3 flex-wrap">
                  <button className="flex-1 px-6 py-3 bg-[#ef4444] text-white rounded-xl font-medium hover:bg-[#dc2626] transition-colors">
                    Delete
                  </button>
                  <button className="flex-1 px-6 py-3 bg-[#e2e8f0] text-[#1f2937] rounded-xl font-medium hover:bg-[#d1d5db] transition-colors">
                    Reply
                  </button>
                  <button className="flex-1 px-6 py-3 bg-[#9ca3af] text-white rounded-xl font-medium hover:bg-[#6b7280] transition-colors">
                    Archive
                  </button>
                </div>
              </motion.div>
