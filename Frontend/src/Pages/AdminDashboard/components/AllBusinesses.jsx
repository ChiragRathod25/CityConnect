...
const AllBusinesses = () => {
  ...
  const filteredSellers = businesses.filter((business) => {
    ...
    const categoryMatch =
      ...
      business.categoryOfBusiness.toLowerCase() ===
  ...
  return (
    <div className="min-h-[800px] overflow-y-auto bg-[#FEF6EF] p-6  flex flex-col gap-6">
      ...
      <div
        ref={dropdownRef}
        className="flex flex-col md:flex-row mx-auto lg:mx-0 mt-10 md:mt-0 gap-4 mb-2"
      >
        {/* City Dropdown with Search */}
        <div className="relative">
          <button
            className="flex items-center text-gray-700 font-medium px-4 py-2 border border-gray-300 rounded-lg bg-white gap-2 w-70 lg:w-80"
          ...
          {cityDropdown && (
            <div className="absolute bg-white shadow-md rounded-lg  lg:w-80 mt-2 w-70 p-2 z-10 h-64 overflow-y-auto">
              <input
                type="text"
        ...
        <div className="relative">
          ...
          {categoryDropdown && (
            <div className="absolute bg-white shadow-md rounded-lg mt-2  lg:w-80  w-70 p-2 z-10 h-64 overflow-y-auto">
              <input
                type="text"
          ...
          >
            ...
            >
              ...
              <p className="text-gray-700">
                ...
                {selectedSeller.categoryOfBusiness}
              </p>
              <p className="text-gray-700">
                <strong>Email:</strong>{" "}
                {selectedSeller.sellerDetails.email || "N/A"}
              </p>
              <p className="text-gray-700">
              ...
              <p className="text-gray-700">
                ...
                {selectedSeller.isActive === true ? "True" : "False"}
              </p>
            </div>
          </motion.div>
        </>
